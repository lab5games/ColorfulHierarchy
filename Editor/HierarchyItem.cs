...
namespace ColorfulHierarchy
{
    public struct HierarchyItem
    {
        ...
        public ColorfulObject ColorfulObject { get; }
        ...
        public HierarchyItem(int instanceID, Rect selectionRect, ColorfulObject colorfulObject)
        {
            InstanceID = instanceID;
            IsSelected = Selection.Contains(instanceID);
            GameObject = colorfulObject.gameObject;
